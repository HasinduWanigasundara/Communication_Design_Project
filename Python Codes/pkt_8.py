...
import pkt_8_epy_block_0_0 as epy_block_0_0  # embedded python block
...
class pkt_8(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "NETLINK COM SYSTEM", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("NETLINK COM SYSTEM")
        ...
        self.top_grid_layout.addWidget(self._qtgui_freq_sink_x_2_win, 5, 0, 1, 1)
        for r in range(5, 6):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.top_grid_layout.addWidget(self._qtgui_const_sink_x_3_win, 5, 1, 1, 1)
        for r in range(5, 6):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.top_grid_layout.addWidget(self._qtgui_const_sink_x_2_win, 5, 2, 1, 1)
        for r in range(5, 6):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(2, 3):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.top_grid_layout.addWidget(self._qtgui_const_sink_x_1_win, 3, 2, 1, 1)
        for r in range(3, 4):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(2, 3):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.top_grid_layout.addWidget(self._qtgui_const_sink_x_0_0_0_0_win, 2, 1, 1, 1)
        for r in range(2, 3):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.top_grid_layout.addWidget(self._qtgui_const_sink_x_0_0_0_win, 4, 1, 1, 1)
        for r in range(4, 5):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.epy_block_6_0 = epy_block_6_0.ack_filter(timeout=0.01)
        self.epy_block_6 = epy_block_6.ack_filter(timeout=0.01)
        self.epy_block_5_0 = epy_block_5_0.PDUQueueStorage(timeout=1, max_retries=4)
        self.epy_block_5 = epy_block_5.PDUQueueStorage(timeout=1, max_retries=4)
        ...
        self.epy_block_0_0 = epy_block_0_0.ack_repeater(num_repeats=1, delay=1)
        self.epy_block_0 = epy_block_0.ack_repeater(num_repeats=1, delay=1)
        ...
        self.msg_connect((self.epy_block_0_0, 'out'), (self.digital_crc_append_0_0_0, 'in'))
        ...
        self.msg_connect((self.epy_block_12, 'pdu_out'), (self.digital_protocol_formatter_async_0, 'in'))
        self.msg_connect((self.epy_block_12_0, 'pdu_out'), (self.digital_protocol_formatter_async_0_1, 'in'))
        ...
        self.msg_connect((self.epy_block_8_0, 'pdu_out'), (self.epy_block_0_0, 'in'))
        ...
        self.connect((self.channels_channel_model_0_1, 0), (self.qtgui_freq_sink_x_2, 0))
        ...
        self.connect((self.digital_constellation_modulator_0, 0), (self.qtgui_const_sink_x_0_0_0_0, 0))
        ...
        self.connect((self.digital_constellation_modulator_0_1, 0), (self.qtgui_const_sink_x_0_0_0, 0))
        ...
        self.connect((self.digital_costas_loop_cc_0_0_0, 0), (self.qtgui_const_sink_x_2, 0))
        self.connect((self.digital_costas_loop_cc_0_0_0_0, 0), (self.digital_constellation_decoder_cb_0_0_0, 0))
        self.connect((self.digital_costas_loop_cc_0_0_0_0, 0), (self.qtgui_const_sink_x_1, 0))
        ...
        self.connect((self.digital_symbol_sync_xx_0_0, 0), (self.qtgui_const_sink_x_3, 0))
